...
public class ItemParser {
   ...
   private static final BiFunction<SuggestionsBuilder, Registry<Item>, CompletableFuture<Suggestions>> SUGGEST_NOTHING = (var0, var1) -> {
   ...
   private BiFunction<SuggestionsBuilder, Registry<Item>, CompletableFuture<Suggestions>> suggestions;
   ...
   private CompletableFuture<Suggestions> suggestOpenNbt(SuggestionsBuilder var1, Registry<Item> var2) {
   ...
   private CompletableFuture<Suggestions> suggestTag(SuggestionsBuilder var1, Registry<Item> var2) {
      return SharedSuggestionProvider.suggestResource(var2.getTagNames().map(TagKey::location), var1.createOffset(this.tagCursor));
   }

   private CompletableFuture<Suggestions> suggestItemIdOrTag(SuggestionsBuilder var1, Registry<Item> var2) {
      if (this.forTesting) {
   ...
   public CompletableFuture<Suggestions> fillSuggestions(SuggestionsBuilder var1, Registry<Item> var2) {
