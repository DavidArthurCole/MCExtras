...
public class EnderDragon extends Mob implements Enemy {
      ...
      if (this.isDeadOrDying()) {
         ...
         if (this.isNoAi()) {
            ...
            for(var36 = 0; var36 < 3; ++var36) {
               ...
               this.tickPart(var15, (double)(-(var8 * 1.5F + var18 * var39) * var31), var37[1] - var35[1] - (double)((var39 + 1.5F) * var6) + 1.5D, (double)((var33 * 1.5F + var19 * var39) * var31));
            }
   ...
   public boolean hurt(DamageSource var1, float var2) {
      if (var1 instanceof EntityDamageSource && ((EntityDamageSource)var1).isThorns() && !this.level.isClientSide) {
