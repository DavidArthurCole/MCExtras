...
public class Slime extends Mob implements Enemy {
   ...
   public static boolean checkSlimeSpawnRules(EntityType<Slime> var0, LevelAccessor var1, MobSpawnType var2, BlockPos var3, Random var4) {
      if (var1.getDifficulty() != Difficulty.PEACEFUL) {
         if (var1.getBiome(var3).is(Biomes.SWAMP) && var3.getY() > 50 && var3.getY() < 70 && var4.nextFloat() < 0.5F && var4.nextFloat() < var1.getMoonBrightness() && var1.getMaxLocalRawBrightness(var3) <= var4.nextInt(8)) {
