...
public class VillagerTrades {
   ...
   private static class TreasureMapForEmeralds implements VillagerTrades.ItemListing {
      ...
      public TreasureMapForEmeralds(int var1, TagKey<ConfiguredStructureFeature<?, ?>> var2, String var3, MapDecoration.Type var4, int var5, int var6) {
      ...
      public MerchantOffer getOffer(Entity var1, Random var2) {
         if (!(var1.level instanceof ServerLevel)) {
            ...
            if (var4 != null) {
               ...
               var5.setHoverName(new TranslatableComponent(this.displayName));
