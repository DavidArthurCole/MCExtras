...
public class Dolphin extends WaterAnimal {
   ...
   private static class DolphinSwimToTreasureGoal extends Goal {
      ...
      public boolean canContinueToUse() {
         ...
         return !(new BlockPos((double)var1.getX(), this.dolphin.getY(), (double)var1.getZ())).closerToCenterThan(this.dolphin.position(), 4.0D) && !this.stuck && this.dolphin.getAirSupply() >= 100;
      }
      ...
      public void start() {
         if (this.dolphin.level instanceof ServerLevel) {
            ...
            BlockPos var3 = var1.findNearestMapFeature(ConfiguredStructureTags.DOLPHIN_LOCATED, var2, 50, false);
            if (var3 != null) {
      ...
      public void stop() {
         BlockPos var1 = this.dolphin.getTreasurePos();
         if ((new BlockPos((double)var1.getX(), this.dolphin.getY(), (double)var1.getZ())).closerToCenterThan(this.dolphin.position(), 4.0D) || this.stuck) {
