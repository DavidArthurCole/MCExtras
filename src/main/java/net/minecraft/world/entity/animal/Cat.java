...
public class Cat extends TamableAnimal {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor var1, DifficultyInstance var2, MobSpawnType var3, @Nullable SpawnGroupData var4, @Nullable CompoundTag var5) {
      ...
      if (var6 instanceof ServerLevel) {
         ...
         Registry var8 = var7.registryAccess().registryOrThrow(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY);
         if (ChunkGenerator.allConfigurations(var8, StructureFeature.SWAMP_HUT).anyMatch((var2x) -> {
            return var7.structureFeatureManager().getStructureWithPieceAt(this.blockPosition(), var2x).isValid();
         })) {
            this.setCatType(10);
