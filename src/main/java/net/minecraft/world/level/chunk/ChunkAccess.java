...
public abstract class ChunkAccess implements BlockGetter, BiomeManager.NoiseBiomeSource, FeatureAccess {
   ...
   public void setAllStarts(Map<ConfiguredStructureFeature<?, ?>, StructureStart> var1) {
   ...
   public NoiseChunk getOrCreateNoiseChunk(NoiseRouter var1, Supplier<DensityFunctions.BeardifierOrMarker> var2, NoiseGeneratorSettings var3, Aquifer.FluidPicker var4, Blender var5) {
   ...
   /** @deprecated */
   @Deprecated
   public Holder<Biome> carverBiome(Supplier<Holder<Biome>> var1) {
      if (this.carverBiome == null) {
         this.carverBiome = (Holder)var1.get();
      }
