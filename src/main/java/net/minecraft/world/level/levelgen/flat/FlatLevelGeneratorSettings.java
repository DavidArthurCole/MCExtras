...
public class FlatLevelGeneratorSettings {
   ...
   public FlatLevelGeneratorSettings(Optional<HolderSet<StructureSet>> var1, Registry<Biome> var2) {
      ...
      this.biome = var2.getOrCreateHolder(Biomes.PLAINS);
   ...
   public Holder<Biome> getBiomeFromSettings() {
      Biome var1 = (Biome)this.getBiome().value();
      ...
      boolean var4 = (!this.voidGen || this.biome.is(Biomes.THE_VOID)) && this.decoration;
      List var5;
      int var6;
      if (var4) {
         var5 = var2.features();
      ...
      return Holder.direct(Biome.BiomeBuilder.from(var1).generationSettings(var3.build()).build());
   }
