...
public class SurfaceSystem {
   ...
   public void buildSurface(BiomeManager var1, Registry<Biome> var2, boolean var3, WorldGenerationContext var4, final ChunkAccess var5, NoiseChunk var6, SurfaceRules.RuleSource var7) {
      ...
      for(int var16 = 0; var16 < 16; ++var16) {
         for(int var17 = 0; var17 < 16; ++var17) {
            ...
            Holder var21 = var1.getBiome(var15.set(var18, var3 ? 0 : var20, var19));
            ...
            for(int var27 = var22; var27 >= var26; --var27) {
               ...
               if (var28.isAir()) {
                  ...
                  if (var28 == this.defaultBlock) {
                     var30 = var14.tryApply(var18, var27, var19);
                     if (var30 != null) {
            ...
            if (var21.is(Biomes.FROZEN_OCEAN) || var21.is(Biomes.DEEP_FROZEN_OCEAN)) {
               this.frozenOceanExtension(var13.getMinSurfaceLevel(), (Biome)var21.value(), var12, var15, var18, var19, var20);
            }
         }
      }
   ...
   protected int getSurfaceDepth(int var1, int var2) {
      ...
      return (int)(var3 * 2.75D + 3.0D + this.randomFactory.at(var1, 0, var2).nextDouble() * 0.25D);
   }
   ...
   private void frozenOceanExtension(int var1, Biome var2, BlockColumn var3, BlockPos.MutableBlockPos var4, int var5, int var6, int var7) {
      ...
      if (!(var10 <= 1.8D)) {
         ...
         double var22 = var20;
         RandomSource var24 = this.randomFactory.at(var5, 0, var6);
