...
public class CanyonWorldCarver extends WorldCarver<CanyonCarverConfiguration> {
   ...
   public boolean carve(CarvingContext var1, CanyonCarverConfiguration var2, ChunkAccess var3, Function<BlockPos, Holder<Biome>> var4, Random var5, Aquifer var6, ChunkPos var7, CarvingMask var8) {
   ...
   // $FF: synthetic method
   // $FF: bridge method
   public boolean isStartChunk(CarverConfiguration var1, Random var2) {
      return this.isStartChunk((CanyonCarverConfiguration)var1, var2);
   }

   // $FF: synthetic method
   // $FF: bridge method
   public boolean carve(CarvingContext var1, CarverConfiguration var2, ChunkAccess var3, Function var4, Random var5, Aquifer var6, ChunkPos var7, CarvingMask var8) {
