...
public interface BuiltinStructures {
   ...
   private static ResourceKey<ConfiguredStructureFeature<?, ?>> createKey(String var0) {
      return ResourceKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation(var0));
   }
}
