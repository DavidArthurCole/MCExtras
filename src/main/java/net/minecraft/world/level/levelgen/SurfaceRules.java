...
public class SurfaceRules {
   ...
   public interface ConditionSource extends Function<SurfaceRules.Context, SurfaceRules.Condition> {
      ...
      static Codec<? extends SurfaceRules.ConditionSource> bootstrap(Registry<Codec<? extends SurfaceRules.ConditionSource>> var0) {
         Registry.register(var0, (String)"biome", SurfaceRules.BiomeConditionSource.CODEC);
         Registry.register(var0, (String)"noise_threshold", SurfaceRules.NoiseThresholdConditionSource.CODEC);
         Registry.register(var0, (String)"vertical_gradient", SurfaceRules.VerticalGradientConditionSource.CODEC);
         Registry.register(var0, (String)"y_above", SurfaceRules.YConditionSource.CODEC);
         Registry.register(var0, (String)"water", SurfaceRules.WaterConditionSource.CODEC);
         Registry.register(var0, (String)"temperature", SurfaceRules.Temperature.CODEC);
         Registry.register(var0, (String)"steep", SurfaceRules.Steep.CODEC);
         Registry.register(var0, (String)"not", SurfaceRules.NotConditionSource.CODEC);
         Registry.register(var0, (String)"hole", SurfaceRules.Hole.CODEC);
         Registry.register(var0, (String)"above_preliminary_surface", SurfaceRules.AbovePreliminarySurface.CODEC);
         return (Codec)Registry.register(var0, (String)"stone_depth", SurfaceRules.StoneDepthCheck.CODEC);
      }
   ...
   static final class BiomeConditionSource implements SurfaceRules.ConditionSource {
      ...
      static {
         CODEC = ResourceKey.codec(Registry.BIOME_REGISTRY).listOf().fieldOf("biome_is").xmap(SurfaceRules::isBiome, (var0) -> {
            return var0.biomes;
         }).codec();
      }
   }
   ...
   public interface RuleSource extends Function<SurfaceRules.Context, SurfaceRules.SurfaceRule> {
      ...
      static Codec<? extends SurfaceRules.RuleSource> bootstrap(Registry<Codec<? extends SurfaceRules.RuleSource>> var0) {
         Registry.register(var0, (String)"bandlands", SurfaceRules.Bandlands.CODEC);
         Registry.register(var0, (String)"block", SurfaceRules.BlockRuleSource.CODEC);
         Registry.register(var0, (String)"sequence", SurfaceRules.SequenceRuleSource.CODEC);
         return (Codec)Registry.register(var0, (String)"condition", SurfaceRules.TestRuleSource.CODEC);
      }
   ...
   protected static final class Context {
      ...
      protected Context(SurfaceSystem var1, ChunkAccess var2, NoiseChunk var3, Function<BlockPos, Holder<Biome>> var4, Registry<Biome> var5, WorldGenerationContext var6) {
