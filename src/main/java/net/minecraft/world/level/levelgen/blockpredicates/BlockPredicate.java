...
public interface BlockPredicate extends BiPredicate<WorldGenLevel, BlockPos> {
   ...
   static BlockPredicate matchesBlocks(List<Block> var0, Vec3i var1) {
      return new MatchingBlocksPredicate(var1, HolderSet.direct(Block::builtInRegistryHolder, var0));
   }
   ...
   static BlockPredicate matchesTag(TagKey<Block> var0, Vec3i var1) {
   ...
   static BlockPredicate matchesFluids(List<Fluid> var0, Vec3i var1) {
      return new MatchingFluidsPredicate(var1, HolderSet.direct(Fluid::builtInRegistryHolder, var0));
   }
