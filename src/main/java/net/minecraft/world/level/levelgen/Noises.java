...
public class Noises {
   ...
   public static NormalNoise instantiate(Registry<NormalNoise.NoiseParameters> var0, PositionalRandomFactory var1, ResourceKey<NormalNoise.NoiseParameters> var2) {
      ...
      return instantiate(var1, var3);
   }

   public static NormalNoise instantiate(PositionalRandomFactory var0, Holder<NormalNoise.NoiseParameters> var1) {
      return NormalNoise.create(var0.fromHashOf(((ResourceKey)var1.unwrapKey().orElseThrow()).location()), (NormalNoise.NoiseParameters)var1.value());
   }
}
