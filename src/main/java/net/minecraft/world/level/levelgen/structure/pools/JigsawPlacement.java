...
public class JigsawPlacement {
   ...
   public static Optional<PieceGenerator<JigsawConfiguration>> addPieces(PieceGeneratorSupplier.Context<JigsawConfiguration> var0, JigsawPlacement.PieceFactory var1, BlockPos var2, boolean var3, boolean var4) {
      ...
      StructureTemplatePool var14 = (StructureTemplatePool)var7.startPool().value();
         ...
         if (!var11.test(var8.getNoiseBiome(QuartPos.fromBlock(var18), QuartPos.fromBlock(var20), QuartPos.fromBlock(var19)))) {
            ...
            return Optional.of((var13x, var14x) -> {
               ...
               if (var7.maxDepth() > 0) {
                  ...
                  var18x.placing.addLast(new JigsawPlacement.PieceState(var16, new MutableObject(Shapes.join(Shapes.create(var17x), Shapes.create(AABB.of(var17)), BooleanOp.ONLY_FIRST)), 0));
                        ...
                        if (var24.isPresent() && (((StructureTemplatePool)var24.get()).size() != 0 || Objects.equals(var23, Pools.EMPTY.location()))) {
                           ...
                           while(var28.hasNext()) {
                              ...
                              while(var30.hasNext()) {
                                 ...
                                 } while(Shapes.joinIsNotEmpty((VoxelShape)var25.getValue(), Shapes.create(AABB.of(var47).deflate(0.25D)), BooleanOp.ONLY_SECOND));

                                 var25.setValue(Shapes.joinUnoptimized((VoxelShape)var25.getValue(), Shapes.create(AABB.of(var47)), BooleanOp.ONLY_FIRST));
