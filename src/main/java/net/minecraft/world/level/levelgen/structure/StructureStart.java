...
public final class StructureStart {
   ...
   public StructureStart(ConfiguredStructureFeature<?, ?> var1, ChunkPos var2, int var3, PiecesContainer var4) {
      this.feature = var1;
      this.chunkPos = var2;
   ...
   public void placeInChunk(WorldGenLevel var1, StructureFeatureManager var2, ChunkGenerator var3, Random var4, BoundingBox var5, ChunkPos var6) {
      ...
      if (!var7.isEmpty()) {
         ...
         this.feature.feature.getPostPlacementProcessor().afterPlace(var1, var2, var3, var4, var5, var6, this.pieceContainer);
      }
   }
   ...
   public CompoundTag createTag(StructurePieceSerializationContext var1, ChunkPos var2) {
      ...
      if (this.isValid()) {
         var3.putString("id", var1.registryAccess().registryOrThrow(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY).getKey(this.feature).toString());
