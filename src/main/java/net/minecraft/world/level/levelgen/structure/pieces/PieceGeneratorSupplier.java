...
public interface PieceGeneratorSupplier<C extends FeatureConfiguration> {
   ...
   public static record Context<C extends FeatureConfiguration>(ChunkGenerator a, BiomeSource b, long c, ChunkPos d, C e, LevelHeightAccessor f, Predicate<Holder<Biome>> g, StructureManager h, RegistryAccess i) {
      ...
      public Context(ChunkGenerator var1, BiomeSource var2, long var3, ChunkPos var5, C var6, LevelHeightAccessor var7, Predicate<Holder<Biome>> var8, StructureManager var9, RegistryAccess var10) {
      ...
      public boolean validBiomeOnTop(Heightmap.Types var1) {
         ...
         Holder var5 = this.chunkGenerator.getNoiseBiome(QuartPos.fromBlock(var2), QuartPos.fromBlock(var4), QuartPos.fromBlock(var3));
