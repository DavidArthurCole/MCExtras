...
public class BlendingData {
   ...
   private void addValuesForColumn(int var1, ChunkAccess var2, int var3, int var4) {
      ...
      this.biomes.set(var1, var2.getNoiseBiome(QuartPos.fromBlock(var3), QuartPos.fromBlock(Mth.floor(this.heights[var1])), QuartPos.fromBlock(var4)));
   }
   ...
   private static double getDensity(@Nullable double[] var0, int var1) {
      if (var0 == null) {
         ...
         return var2 >= 0 && var2 < var0.length ? var0[var2] * 0.1D : Double.MAX_VALUE;
      }
   }
   ...
   protected double getDensity(int var1, int var2, int var3) {
      if (var2 == getMinY()) {
         ...
         return var1 != 0 && var3 != 0 ? Double.MAX_VALUE : getDensity(this.densities[getInsideIndex(var1, var3)], var2);
      } else {
         return getDensity(this.densities[getOutsideIndex(var1, var3)], var2);
      }
   }

   protected void iterateBiomes(int var1, int var2, BlendingData.BiomeConsumer var3) {
      for(int var4 = 0; var4 < this.biomes.size(); ++var4) {
         Holder var5 = (Holder)this.biomes.get(var4);
         if (var5 != null) {
