...
public class DimensionType {
   ...
   private DimensionType(OptionalLong var1, boolean var2, boolean var3, boolean var4, boolean var5, double var6, boolean var8, boolean var9, boolean var10, boolean var11, int var12, int var13, int var14, TagKey<Block> var15, ResourceLocation var16, float var17) {
      this(var1, var2, var3, var4, var5, var6, false, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17);
   }

   public static DimensionType create(OptionalLong var0, boolean var1, boolean var2, boolean var3, boolean var4, double var5, boolean var7, boolean var8, boolean var9, boolean var10, boolean var11, int var12, int var13, int var14, TagKey<Block> var15, ResourceLocation var16, float var17) {
   ...
   /** @deprecated */
   @Deprecated
   private DimensionType(OptionalLong var1, boolean var2, boolean var3, boolean var4, boolean var5, double var6, boolean var8, boolean var9, boolean var10, boolean var11, boolean var12, int var13, int var14, int var15, TagKey<Block> var16, ResourceLocation var17, float var18) {
      this.fixedTime = var1;
   ...
   public static RegistryAccess.Writable registerBuiltin(RegistryAccess.Writable var0) {
      WritableRegistry var1 = var0.ownedWritableRegistryOrThrow(Registry.DIMENSION_TYPE_REGISTRY);
   ...
   public static Registry<LevelStem> defaultDimensions(RegistryAccess var0, long var1) {
      return defaultDimensions(var0, var1, true);
   }

   public static Registry<LevelStem> defaultDimensions(RegistryAccess var0, long var1, boolean var3) {
      MappedRegistry var4 = new MappedRegistry(Registry.LEVEL_STEM_REGISTRY, Lifecycle.experimental(), (Function)null);
      ...
      Registry var7 = var0.registryOrThrow(Registry.STRUCTURE_SET_REGISTRY);
      Registry var8 = var0.registryOrThrow(Registry.NOISE_GENERATOR_SETTINGS_REGISTRY);
      Registry var9 = var0.registryOrThrow(Registry.NOISE_REGISTRY);
      var4.register(LevelStem.NETHER, new LevelStem(var5.getOrCreateHolder(NETHER_LOCATION), new NoiseBasedChunkGenerator(var7, var9, MultiNoiseBiomeSource.Preset.NETHER.biomeSource(var6, var3), var1, var8.getOrCreateHolder(NoiseGeneratorSettings.NETHER))), Lifecycle.stable());
      var4.register(LevelStem.END, new LevelStem(var5.getOrCreateHolder(END_LOCATION), new NoiseBasedChunkGenerator(var7, var9, new TheEndBiomeSource(var6, var1), var1, var8.getOrCreateHolder(NoiseGeneratorSettings.END))), Lifecycle.stable());
      return var4;
   }
   ...
   static {
      ...
      DEFAULT_OVERWORLD = create(OptionalLong.empty(), true, false, false, true, 1.0D, false, false, true, false, true, -64, 384, 384, BlockTags.INFINIBURN_OVERWORLD, OVERWORLD_EFFECTS, 0.0F);
      DEFAULT_NETHER = create(OptionalLong.of(18000L), false, true, true, false, 8.0D, false, true, false, true, false, 0, 256, 128, BlockTags.INFINIBURN_NETHER, NETHER_EFFECTS, 0.1F);
      DEFAULT_END = create(OptionalLong.of(6000L), false, false, false, false, 1.0D, true, false, false, false, true, 0, 256, 256, BlockTags.INFINIBURN_END, END_EFFECTS, 0.0F);
      OVERWORLD_CAVES_LOCATION = ResourceKey.create(Registry.DIMENSION_TYPE_REGISTRY, new ResourceLocation("overworld_caves"));
      DEFAULT_OVERWORLD_CAVES = create(OptionalLong.empty(), true, true, false, true, 1.0D, false, false, true, false, true, -64, 384, 384, BlockTags.INFINIBURN_OVERWORLD, OVERWORLD_EFFECTS, 0.0F);
