...
public class ExplorationMapFunction extends LootItemConditionalFunction {
   ...
   public static final TagKey<ConfiguredStructureFeature<?, ?>> DEFAULT_FEATURE;
   ...
   ExplorationMapFunction(LootItemCondition[] var1, TagKey<ConfiguredStructureFeature<?, ?>> var2, MapDecoration.Type var3, byte var4, int var5, boolean var6) {
      super(var1);
   ...
   static {
      DEFAULT_FEATURE = ConfiguredStructureTags.ON_TREASURE_MAPS;
   ...
   public static class Builder extends LootItemConditionalFunction.Builder<ExplorationMapFunction.Builder> {
      ...
      public ExplorationMapFunction.Builder setDestination(TagKey<ConfiguredStructureFeature<?, ?>> var1) {
   ...
   public static class Serializer extends LootItemConditionalFunction.Serializer<ExplorationMapFunction> {
      ...
      private static TagKey<ConfiguredStructureFeature<?, ?>> readStructure(JsonObject var0) {
         if (var0.has("destination")) {
            String var1 = GsonHelper.getAsString(var0, "destination");
            return TagKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation(var1));
         } else {
