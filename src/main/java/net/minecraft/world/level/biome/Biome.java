...
public final class Biome {
   ...
   /** @deprecated */
   @Deprecated
   public static Biome.BiomeCategory getBiomeCategory(Holder<Biome> var0) {
      return ((Biome)var0.value()).getBiomeCategory();
   }
   ...
   public static class BiomeBuilder {
      ...
      public static Biome.BiomeBuilder from(Biome var0) {
         return (new Biome.BiomeBuilder()).precipitation(var0.getPrecipitation()).biomeCategory(var0.getBiomeCategory()).temperature(var0.getBaseTemperature()).downfall(var0.getDownfall()).specialEffects(var0.getSpecialEffects()).generationSettings(var0.getGenerationSettings()).mobSpawnSettings(var0.getMobSettings());
      }
