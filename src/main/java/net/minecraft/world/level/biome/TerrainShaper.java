...
public record TerrainShaper(CubicSpline<TerrainShaper.Point> c, CubicSpline<TerrainShaper.Point> d, CubicSpline<TerrainShaper.Point> e) {
   ...
   public static final Codec<CubicSpline<TerrainShaper.PointCustom>> SPLINE_CUSTOM_CODEC;
   ...
   public static TerrainShaper.Point makePoint(float var0, float var1, float var2) {
      return new TerrainShaper.Point(var0, var1, peaksAndValleys(var2), var2);
   }

   public static TerrainShaper.PointCustom makePoint(DensityFunction.FunctionContext var0) {
      return new TerrainShaper.PointCustom(var0);
   }
   ...
   static {
      ...
      SPLINE_CUSTOM_CODEC = CubicSpline.codec(TerrainShaper.CoordinateCustom.WIDE_CODEC);
   ...
   public static record PointCustom(DensityFunction.FunctionContext a) {
      ...
      public PointCustom(DensityFunction.FunctionContext var1) {
         this.context = var1;
      }
   ...
   public static record CoordinateCustom(Holder<DensityFunction> a) implements ToFloatFunction<TerrainShaper.PointCustom> {
      ...
      static final Codec<ToFloatFunction<TerrainShaper.PointCustom>> WIDE_CODEC;

      public CoordinateCustom(Holder<DensityFunction> var1) {
         this.function = var1;
      }

      public float apply(TerrainShaper.PointCustom var1) {
         return (float)((DensityFunction)this.function.value()).compute(var1.context());
      }

      public TerrainShaper.CoordinateCustom mapAll(DensityFunction.Visitor var1) {
         return new TerrainShaper.CoordinateCustom(new Holder.Direct(((DensityFunction)this.function.value()).mapAll(var1)));
      }
      ...
      // $FF: synthetic method
      public float apply(Object var1) {
         return this.apply((TerrainShaper.PointCustom)var1);
      }

      static {
         WIDE_CODEC = DensityFunction.CODEC.flatComapMap(TerrainShaper.CoordinateCustom::new, (var0) -> {
            DataResult var10000;
            if (var0 instanceof TerrainShaper.CoordinateCustom) {
               TerrainShaper.CoordinateCustom var1 = (TerrainShaper.CoordinateCustom)var0;
               var10000 = DataResult.success(var1.function());
            } else {
               var10000 = DataResult.error("Not a coordinate resolver: " + var0);
            }
