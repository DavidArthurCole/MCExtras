...
public class AdventureAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   private static UsingItemTrigger.TriggerInstance lookAtThroughItem(EntityType<?> var0, Item var1) {
      return UsingItemTrigger.TriggerInstance.lookingAt(EntityPredicate.Builder.entity().player(PlayerPredicate.Builder.player().setLookingAt(EntityPredicate.Builder.entity().of(var0).build()).build()), ItemPredicate.Builder.item().of(var1));
   }
   ...
   public void accept(Consumer<Advancement> var1) {
      ...
      Advancement var9 = Advancement.Builder.advancement().parent(var2).display((ItemStack)Raid.getLeaderBannerInstance(), new TranslatableComponent("advancements.adventure.voluntary_exile.title"), new TranslatableComponent("advancements.adventure.voluntary_exile.description"), (ResourceLocation)null, FrameType.TASK, true, true, true).addCriterion("voluntary_exile", (CriterionTriggerInstance)KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(EntityTypeTags.RAIDERS).equipment(EntityEquipmentPredicate.CAPTAIN))).save(var1, "adventure/voluntary_exile");
      ...
      Advancement.Builder.advancement().parent(var2).display((ItemLike)Items.LIGHTNING_ROD, new TranslatableComponent("advancements.adventure.lightning_rod_with_villager_no_fire.title"), new TranslatableComponent("advancements.adventure.lightning_rod_with_villager_no_fire.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("lightning_rod_with_villager_no_fire", (CriterionTriggerInstance)fireCountAndBystander(MinMaxBounds.Ints.exactly(0), EntityPredicate.Builder.entity().of(EntityType.VILLAGER).build())).save(var1, "adventure/lightning_rod_with_villager_no_fire");
      ...
      Advancement.Builder.advancement().parent(var3).display((ItemLike)Items.JUKEBOX, new TranslatableComponent("advancements.adventure.play_jukebox_in_meadows.title"), new TranslatableComponent("advancements.adventure.play_jukebox_in_meadows.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("play_jukebox_in_meadows", (CriterionTriggerInstance)ItemUsedOnBlockTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBiome(Biomes.MEADOW).setBlock(BlockPredicate.Builder.block().of(Blocks.JUKEBOX).build()), ItemPredicate.Builder.item().of(ItemTags.MUSIC_DISCS))).save(var1, "adventure/play_jukebox_in_meadows");
   ...
   private List<ResourceKey<Biome>> getAllOverworldBiomes() {
      return (List)MultiNoiseBiomeSource.Preset.OVERWORLD.biomeSource(BuiltinRegistries.BIOME).possibleBiomes().stream().flatMap((var0) -> {
