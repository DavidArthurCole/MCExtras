...
public class WorldgenRegistryDumpReport implements DataProvider {
   ...
   public void run(HashCache var1) {
      ...
      RegistryAccess var3 = (RegistryAccess)RegistryAccess.BUILTIN.get();
      boolean var4 = false;
      Registry var5 = DimensionType.defaultDimensions(var3, 0L, false);
      NoiseBasedChunkGenerator var6 = WorldGenSettings.makeDefaultOverworld(var3, 0L, false);
      Registry var7 = WorldGenSettings.withOverworld(var3.ownedRegistryOrThrow(Registry.DIMENSION_TYPE_REGISTRY), (Registry)var5, var6);
      RegistryOps var8 = RegistryOps.create(JsonOps.INSTANCE, var3);
