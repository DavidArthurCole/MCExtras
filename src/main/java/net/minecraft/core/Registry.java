...
public abstract class Registry<T> implements Keyable, IdMap<T> {
   ...
   static {
      ...
      MOTIVE = registerDefaulted(MOTIVE_REGISTRY, "kebab", (var0) -> {
         return Motive.KEBAB;
      });
      ...
      POINT_OF_INTEREST_TYPE = registerDefaulted(POINT_OF_INTEREST_TYPE_REGISTRY, "unemployed", (var0) -> {
      ...
      STRUCTURE_FEATURE = registerSimple(STRUCTURE_FEATURE_REGISTRY, (var0) -> {
      ...
      BIOME_SOURCE = registerSimple(BIOME_SOURCE_REGISTRY, Lifecycle.stable(), (var0) -> {
         return BiomeSource.CODEC;
      });
      CHUNK_GENERATOR = registerSimple(CHUNK_GENERATOR_REGISTRY, Lifecycle.stable(), (var0) -> {
