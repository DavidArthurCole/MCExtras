...
public interface ConfiguredStructureTags {
   ...
   private static TagKey<ConfiguredStructureFeature<?, ?>> create(String var0) {
      return TagKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation(var0));
   }
}
