...
public class TagLoader<T> {
               ...
               try {
                  ...
                  try {
                     ...
                     try {
                        ...
                        if (var11 == null) {
                           LOGGER.error("Couldn't load tag list {} from {} in data pack {} as it is empty or null", new Object[]{var6, var4, var8.getSourceName()});
                        } else {
                  ...
                  LOGGER.error("Couldn't read tag list {} from {} in data pack {}", new Object[]{var6, var4, var8.getSourceName(), var25});
               } finally {
                  IOUtils.closeQuietly(var8);
               }
            }
         } catch (IOException var27) {
            LOGGER.error("Couldn't read tag list {} from {}", new Object[]{var6, var4, var27});
         }
      }
   ...
   public Map<ResourceLocation, Tag<T>> build(Map<ResourceLocation, Tag.Builder> var1) {
      HashMap var2 = Maps.newHashMap();
   ...
   public Map<ResourceLocation, Tag<T>> loadAndBuild(ResourceManager var1) {
