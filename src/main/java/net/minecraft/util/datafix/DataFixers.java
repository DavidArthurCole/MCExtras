...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      var0.addFixer(ItemRenameFix.create(var99, "Rename bee_hive item to beehive", createRenamer("minecraft:bee_hive", "minecraft:beehive")));
      var0.addFixer(new BeehivePoiRenameFix(var99));
      var0.addFixer(BlockRenameFix.create(var99, "Rename bee_hive block to beehive", createRenamer("minecraft:bee_hive", "minecraft:beehive")));
      Schema var100 = var0.addSchema(2211, SAME_NAMESPACED);
      var0.addFixer(new StructureReferenceCountFix(var100, false));
      Schema var101 = var0.addSchema(2218, SAME_NAMESPACED);
      var0.addFixer(new ForcePoiRebuild(var101, false));
      Schema var102 = var0.addSchema(2501, V2501::new);
      var0.addFixer(new FurnaceRecipeFix(var102, true));
      Schema var103 = var0.addSchema(2502, V2502::new);
      var0.addFixer(new AddNewChoices(var103, "Added Hoglin", References.ENTITY));
      Schema var104 = var0.addSchema(2503, SAME_NAMESPACED);
      var0.addFixer(new WallPropertyFix(var104, false));
      var0.addFixer(new AdvancementsRenameFix(var104, false, "Composter category change", createRenamer("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
      Schema var105 = var0.addSchema(2505, V2505::new);
      var0.addFixer(new AddNewChoices(var105, "Added Piglin", References.ENTITY));
      var0.addFixer(new MemoryExpiryDataFix(var105, "minecraft:villager"));
      Schema var106 = var0.addSchema(2508, SAME_NAMESPACED);
      var0.addFixer(ItemRenameFix.create(var106, "Renamed fungi items to fungus", createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      var0.addFixer(BlockRenameFix.create(var106, "Renamed fungi blocks to fungus", createRenamer(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      Schema var107 = var0.addSchema(2509, V2509::new);
      var0.addFixer(new EntityZombifiedPiglinRenameFix(var107));
      var0.addFixer(ItemRenameFix.create(var107, "Rename zombie pigman egg item", createRenamer(EntityZombifiedPiglinRenameFix.RENAMED_IDS)));
      Schema var108 = var0.addSchema(2511, SAME_NAMESPACED);
      var0.addFixer(new EntityProjectileOwnerFix(var108));
      ...
      var0.addFixer(new JigsawRotationFix(var111, false));
      ...
      var0.addFixer(new AttributesRename(var114));
      ...
      var0.addFixer(new RenameBiomesFix(var123, false, "Nether biome rename", ImmutableMap.of("minecraft:nether", "minecraft:nether_wastes")));
      Schema var124 = var0.addSchema(2553, SAME_NAMESPACED);
      var0.addFixer(new BiomeFix(var124, false));
      ...
      var0.addFixer(BlockRenameFixWithJigsaw.create(var129, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
      ...
      var0.addFixer(BlockRenameFixWithJigsaw.create(var140, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
      ...
      var0.addFixer(new RenameBiomesFix(var151, false, "Caves and Cliffs biome renames", CavesAndCliffsRenames.RENAMES));
      ...
      var0.addFixer(new RenameBiomesFix(var154, false, "Remove Deep Warm Ocean", Map.of("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
