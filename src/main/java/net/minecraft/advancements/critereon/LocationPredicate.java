...
public class LocationPredicate {
   ...
   public LocationPredicate(MinMaxBounds.Doubles var1, MinMaxBounds.Doubles var2, MinMaxBounds.Doubles var3, @Nullable ResourceKey<Biome> var4, @Nullable ResourceKey<ConfiguredStructureFeature<?, ?>> var5, @Nullable ResourceKey<Level> var6, @Nullable Boolean var7, LightPredicate var8, BlockPredicate var9, FluidPredicate var10) {
      this.x = var1;
      this.y = var2;
      this.z = var3;
      this.biome = var4;
   ...
   public static LocationPredicate inFeature(ResourceKey<ConfiguredStructureFeature<?, ?>> var0) {
   ...
   public JsonElement serializeToJson() {
      if (this == ANY) {
         ...
         if (this.feature != null) {
            var1.addProperty("feature", this.feature.location().toString());
         }
   ...
   public static LocationPredicate fromJson(@Nullable JsonElement var0) {
      if (var0 != null && !var0.isJsonNull()) {
         ...
         if (var1.has("feature")) {
            var10000 = ResourceLocation.CODEC.parse(JsonOps.INSTANCE, var1.get("feature"));
            var10001 = LOGGER;
            Objects.requireNonNull(var10001);
            var14 = (ResourceKey)var10000.resultOrPartial(var10001::error).map((var0x) -> {
               return ResourceKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, var0x);
            }).orElse((Object)null);
         } else {
            var14 = null;
         }
   ...
   public static class Builder {
      ...
      public LocationPredicate.Builder setFeature(@Nullable ResourceKey<ConfiguredStructureFeature<?, ?>> var1) {
         this.feature = var1;
         return this;
      }
