...
public class SpreadPlayersCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_INVALID_MAX_HEIGHT = new Dynamic2CommandExceptionType((var0, var1) -> {
      return new TranslatableComponent("commands.spreadplayers.failed.invalid.height", new Object[]{var0, var1});
   });
   ...
   private static int spreadPlayers(CommandSourceStack var0, Vec2 var1, float var2, float var3, int var4, boolean var5, Collection<? extends Entity> var6) throws CommandSyntaxException {
      ...
      if (var4 < var8) {
         ...
         var0.sendSuccess(new TranslatableComponent("commands.spreadplayers.success." + (var5 ? "teams" : "entities"), new Object[]{var18.length, var1.x, var1.y, String.format(Locale.ROOT, "%.2f", var19)}), true);
         return var18.length;
      }
   }
