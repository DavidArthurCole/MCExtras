...
public class TextFilterClient implements AutoCloseable {
   ...
   private TextFilterClient(URL var1, URL var2, URL var3, String var4, int var5, String var6, String var7, TextFilterClient.IgnoreStrategy var8, int var9) {
      this.authKey = var4;
      this.ruleId = var5;
      this.serverId = var6;
      this.roomId = var7;
   ...
   private static URL getEndpoint(URI var0, @Nullable JsonObject var1, String var2, String var3) throws MalformedURLException {
      String var4 = var1 != null ? GsonHelper.getAsString(var1, var2, var3) : var3;
      ...
      if (Strings.isNullOrEmpty(var0)) {
         ...
         try {
            ...
            if (var3.isEmpty()) {
               ...
               URL var10 = getEndpoint(var2, var9, "chat", "v1/chat");
               URL var11 = getEndpoint(var2, var9, "join", "v1/join");
               URL var12 = getEndpoint(var2, var9, "leave", "v1/leave");
               TextFilterClient.IgnoreStrategy var13 = TextFilterClient.IgnoreStrategy.select(var7);
               return new TextFilterClient(var10, var11, var12, Base64.getEncoder().encodeToString(var3.getBytes(StandardCharsets.US_ASCII)), var4, var5, var6, var13, var8);
            }
         } catch (Exception var14) {
            LOGGER.warn("Failed to parse chat filter config {}", var0, var14);
            return null;
         }
      }
   }
   ...
   void processJoinOrLeave(GameProfile var1, URL var2, Executor var3) {
      ...
      var3.execute(() -> {
         try {
            ...
            LOGGER.warn("Failed to send join/leave packet to {} for player {}", new Object[]{var2, var1, var5});
         }
