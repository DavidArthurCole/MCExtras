...
public class DedicatedServerProperties extends Settings<DedicatedServerProperties> {
   ...
   public DedicatedServerProperties(Properties var1) {
      ...
      this.worldGenProperties = new DedicatedServerProperties.WorldGenProperties(this.get("level-seed", ""), (JsonObject)this.get("generator-settings", (var0) -> {
   ...
   public WorldGenSettings getWorldGenSettings(RegistryAccess var1) {
      if (this.worldGenSettings == null) {
         this.worldGenSettings = WorldGenSettings.create(var1, this.worldGenProperties);
      }
