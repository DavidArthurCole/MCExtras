...
public class ReloadableServerResources {
   ...
   public static CompletableFuture<ReloadableServerResources> loadResources(ResourceManager var0, RegistryAccess.Frozen var1, Commands.CommandSelection var2, int var3, Executor var4, Executor var5) {
      ...
      return SimpleReloadInstance.create(var0, var6.listeners(), var4, var5, DATA_RELOAD_INITIAL_TASK, LOGGER.isDebugEnabled()).done().thenApply((var1x) -> {
         return var6;
      });
   }
   ...
   private static <T> void updateRegistryTags(RegistryAccess var0, TagManager.LoadResult<T> var1) {
      ...
      Map var3 = (Map)var1.tags().entrySet().stream().collect(Collectors.toUnmodifiableMap((var1x) -> {
         ...
         return ((Tag)var0x.getValue()).getValues();
      }));
