...
public class ClientboundRespawnPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundRespawnPacket(Holder<DimensionType> var1, ResourceKey<Level> var2, long var3, GameType var5, @Nullable GameType var6, boolean var7, boolean var8, boolean var9) {
   ...
   public ClientboundRespawnPacket(FriendlyByteBuf var1) {
      this.dimensionType = (Holder)var1.readWithCodec(DimensionType.CODEC);
