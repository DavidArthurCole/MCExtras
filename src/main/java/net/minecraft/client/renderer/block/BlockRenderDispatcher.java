...
public class BlockRenderDispatcher implements ResourceManagerReloadListener {
   ...
   public boolean renderLiquid(BlockPos var1, BlockAndTintGetter var2, VertexConsumer var3, BlockState var4, FluidState var5) {
      try {
         return this.liquidBlockRenderer.tesselate(var2, var1, var3, var4, var5);
