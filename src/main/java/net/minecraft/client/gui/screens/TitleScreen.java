...
public class TitleScreen extends Screen {
   ...
   public TitleScreen(boolean var1) {
      ...
      this.realms32bitWarningShown = false;
      this.fading = var1;
   ...
   private void showRealms32BitWarningIfNeeded() {
      try {
         if (this.warning32Bit != null && !this.minecraft.options.skipRealms32bitWarning && !this.realms32bitWarningShown && (Boolean)this.warning32Bit.realmsSubscriptionFuture.getNow(false)) {
   ...
   protected void init() {
      ...
      this.addRenderableWidget(new Button(this.width / 2 - 100, var4 + 72 + 12, 98, 20, new TranslatableComponent("menu.options"), (var1x) -> {
         this.minecraft.setScreen(new OptionsScreen(this, this.minecraft.options));
      }));
      this.addRenderableWidget(new Button(this.width / 2 + 2, var4 + 72 + 12, 98, 20, new TranslatableComponent("menu.quit"), (var1x) -> {
         this.minecraft.stop();
      }));
      ...
      if (!this.minecraft.is64Bit()) {
         CompletableFuture var5 = this.warning32Bit != null ? this.warning32Bit.realmsSubscriptionFuture : CompletableFuture.supplyAsync(this::hasRealmsSubscription, Util.backgroundExecutor());
         this.warning32Bit = new TitleScreen.Warning32Bit(MultiLineLabel.create(this.font, new TranslatableComponent("title.32bit.deprecation"), 350, 2), this.width / 2, var4 - 24, var5);
      }
   ...
   private boolean hasRealmsSubscription() {
      try {
         return this.realmsClient.listWorlds().servers.stream().anyMatch((var1) -> {
   ...
   private void createDemoMenuOptions(int var1, int var2) {
      ...
      this.addRenderableWidget(new Button(this.width / 2 - 100, var1, 200, 20, new TranslatableComponent("menu.playdemo"), (var2x) -> {
         if (var3) {
            ...
            RegistryAccess var3x = (RegistryAccess)RegistryAccess.BUILTIN.get();
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if ((var10 & -67108864) != 0) {
         ...
         if (this.warning32Bit != null) {
            MultiLineLabel var10000 = this.warning32Bit.label;
            int var10002 = this.warning32Bit.x;
            int var10003 = this.warning32Bit.y;
            Objects.requireNonNull(this.font);
            var10000.renderBackgroundCentered(var1, var10002, var10003, 9, 2, 1428160512);
            var10000 = this.warning32Bit.label;
            var10002 = this.warning32Bit.x;
            var10003 = this.warning32Bit.y;
            Objects.requireNonNull(this.font);
            var10000.renderCentered(var1, var10002, var10003, 9, 16777215 | var10);
         }
   ...
   static record Warning32Bit(MultiLineLabel a, int b, int c, CompletableFuture<Boolean> d) {
      ...
      Warning32Bit(MultiLineLabel var1, int var2, int var3, CompletableFuture<Boolean> var4) {
         this.label = var1;
         this.x = var2;
         this.y = var3;
         this.realmsSubscriptionFuture = var4;
      }
