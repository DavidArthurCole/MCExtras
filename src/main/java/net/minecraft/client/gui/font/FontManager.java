            ...
            try {
               for(Iterator var10 = var1.getResources(var6).iterator(); var10.hasNext(); var2.pop()) {
                  ...
                  try {
                        ...
                        try {
                           ...
                           for(int var15 = var14.size() - 1; var15 >= 0; --var15) {
                              ...
                              try {
                                 ...
                                 FontManager.LOGGER.warn("Unable to read definition '{}' in {} in resourcepack: '{}': {}", new Object[]{var8, "fonts.json", var11.getSourceName(), var22.getMessage()});
                              }
                           }
                     ...
                     FontManager.LOGGER.warn("Unable to load font '{}' in {} in resourcepack: '{}': {}", new Object[]{var8, "fonts.json", var11.getSourceName(), var25.getMessage()});
                  }
               }
            } catch (IOException var26) {
               FontManager.LOGGER.warn("Unable to load font '{}' in {}: {}", new Object[]{var8, "fonts.json", var26.getMessage()});
            }
