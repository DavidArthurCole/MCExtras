            ...
            public double process(String var1, double var2) {
               ...
               if (var4 != null) {
                  ...
                  try {
                     ...
                     Options.LOGGER.warn("Invalid floating point value for option {} = {}", new Object[]{var1, var4, var6});
                  }
               }
            ...
            public <T> T process(String var1, T var2, IntFunction<T> var3, ToIntFunction<T> var4) {
               ...
               if (var5 != null) {
                  try {
                     ...
                     Options.LOGGER.warn("Invalid integer value for option {} = {}", new Object[]{var1, var5, var7});
                  }
               }
