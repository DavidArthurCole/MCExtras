...
public class GameTestServer extends MinecraftServer {
   ...
   public static GameTestServer create(Thread var0, LevelStorageSource.LevelStorageAccess var1, PackRepository var2, Collection<GameTestBatch> var3, BlockPos var4) {
      if (var3.isEmpty()) {
         ...
         WorldStem.InitConfig var5 = new WorldStem.InitConfig(var2, Commands.CommandSelection.DEDICATED, 4, false);

         try {
            WorldStem var6 = (WorldStem)WorldStem.load(var5, () -> {
               return DataPackConfig.DEFAULT;
            }, (var0x, var1x) -> {
               RegistryAccess.Frozen var2 = (RegistryAccess.Frozen)RegistryAccess.BUILTIN.get();
               Registry var3 = var2.registryOrThrow(Registry.BIOME_REGISTRY);
               Registry var4 = var2.registryOrThrow(Registry.STRUCTURE_SET_REGISTRY);
               Registry var5 = var2.registryOrThrow(Registry.DIMENSION_TYPE_REGISTRY);
               PrimaryLevelData var6 = new PrimaryLevelData(TEST_SETTINGS, new WorldGenSettings(0L, false, false, WorldGenSettings.withOverworld(var5, (Registry)DimensionType.defaultDimensions(var2, 0L), new FlatLevelSource(var4, FlatLevelGeneratorSettings.getDefault(var3, var4)))), Lifecycle.stable());
               return Pair.of(var6, var2);
            }, Util.backgroundExecutor(), Runnable::run).get();
            var6.updateGlobals();
            return new GameTestServer(var0, var1, var2, var6, var3, var4);
         } catch (Exception var7) {
            LOGGER.warn("Failed to load vanilla datapack, bit oops", var7);
            System.exit(-1);
   ...
   private GameTestServer(Thread var1, LevelStorageSource.LevelStorageAccess var2, PackRepository var3, WorldStem var4, Collection<GameTestBatch> var5, BlockPos var6) {
      super(var1, var2, var3, var4, Proxy.NO_PROXY, DataFixers.getDataFixer(), (MinecraftSessionService)null, (GameProfileRepository)null, (GameProfileCache)null, LoggerChunkProgressListener::new);
